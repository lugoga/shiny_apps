...
urls <- paste0("https://www.regions.go.tz/", tolower(gsub(" ", "-", regions)))

# Create different photo URLs for each region using Lorem Picsum with fixed IDs
photo_urls <- paste0("https://picsum.photos/id/", 
                     seq(10, 10 + length(regions) - 1),  # Using IDs 10-40 for consistency
                     "/400/300")  # Size 400x300

    ...
    div(
      ...
      div(
        ...
        layout_columns(
          ...
          card(
            max_height = "100%",
            card_header(tags$span("Billing Plans", style = "font-size: 24px; color: #00480F; font-weight: bold;")),
            div(
          ...
          card(
            ...
            card(
              ...
              selectInput("health_conditions", "Health Conditions*",
                          multiple = TRUE,
                          choices = c("Diabetes", "High Blood Pressure", "Obesity", "General Nutrition", 
                                      "Cancer", "Kidney Disease", "Metabolic", "Others")),
    ...
    showModal(
      modalDialog(
        title = span(bs_icon("info-circle-fill"), "Special Message",
                     style = "margin: 0; font-size: 1.5em; color: #C6E3CC;"),
        div(
          class = "message-text",
          bs_icon("lightning-charge-fill"), 
          "Why suffer? YERP is here for YOU! Don’t wait—grab your plan today!"
        ),
        easyClose = TRUE,
        footer = tagList(
          actionButton(
